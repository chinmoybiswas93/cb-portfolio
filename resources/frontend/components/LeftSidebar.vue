    ...
    <div class="sidebar-content">
      ...
      <div class="sidebar-nav-loading" v-else>
        <div class="nav-loading">
          <div class="loading-skeleton nav-skeleton" v-for="n in 3" :key="`nav-skeleton-${n}`"
      ...
      <div class="contact-section">
        <div class="social-links" v-if="hasData">
          <a v-if="portfolioData.github_url" :href="portfolioData.github_url" target="_blank" class="social-link"
            aria-label="GitHub">
          ...
          <a v-if="portfolioData.linkedin_url" :href="portfolioData.linkedin_url" target="_blank" class="social-link"
            aria-label="LinkedIn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path
          ...
          <a v-if="portfolioData.twitter_url" :href="portfolioData.twitter_url" target="_blank" class="social-link"
            aria-label="Twitter">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path
          ...
          <a v-if="portfolioData.email" :href="`mailto:${portfolioData.email}`" class="social-link" aria-label="Email">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h.245l10.119 7.587 10.119-7.587h.245c.904 0 1.636.732 1.636 1.636z" />
            </svg>
          </a>
          <a v-if="portfolioData.phone" :href="`tel:${portfolioData.phone}`" class="social-link" aria-label="Phone">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path
